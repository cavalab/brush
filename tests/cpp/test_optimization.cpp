...
TEST(Program, OptimizeNotableProductWeight)
{
    /* @brief Tests whether weight optimization works on finding the correct 
        weights for a notable product problem.
        ...
        structure, the fitted model should have an infinitesimally small error.
    */
    Dataset data = Data::read_csv("docs/examples/datasets/d_square_x1_plus_2_x1_x2_plus_square_x2.csv","target");
    SearchSpace SS;
    SS.init(data);
